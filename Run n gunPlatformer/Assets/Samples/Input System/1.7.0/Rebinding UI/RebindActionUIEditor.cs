...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_actionOverRideStringProperty = serializedObject.FindProperty("m_actionLableString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(m_CostomizeUILable, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
        ...
        private GUIContent m_CostomizeUILable = new GUIContent("Customize UI");
