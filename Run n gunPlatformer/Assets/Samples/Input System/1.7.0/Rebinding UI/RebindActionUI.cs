...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public void ResetToDefault()
        {
            ...
            ResetBindingFuntion(action, bindingIndex);
        ...
        private void ResetBindingFuntion(InputAction action, int bindingIndex)
        {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            //dissable action before use to prevent errors 
            action.Disable();
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (CheckDuplecteBindings(action, bindingIndex, allCompositeParts))
                        {
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        private bool CheckDuplecteBindings(InputAction action, int bindingIndex, bool allcompositeParts = false)
        {
            InputBinding newBinding = action.bindings[bindingIndex];
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                {
                    Debug.Log("Duplecte binding found" + newBinding.effectivePath);
                    return true;
                }
            }
        ...
        [Tooltip("What should be displayed for (action label")]
        [SerializeField]
